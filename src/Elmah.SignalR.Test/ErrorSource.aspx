...
<body>
    ...
    <p>
        ...
        demo application, visit <a href="../../../elmah/samples/Demo/elmah.axd/test">elmah.axd/test</a> to generate the test error.
    ...
    <p>
        To see the list of errors logged, vist <a href="../../../elmah/samples/Demo/elmah.axd">elmah.axd</a>.
    </p>
    <p>
        To see the notification mails, go to the <a href="../../../elmah/samples/Demo/Mails/"
    ...
    <ul>
        <li><a href="../../../elmah/samples/Demo/ErrorsGridView.aspx">Error Log Sample Using ObjectDataSource and GridView</a></li>
        <li><a href="../../../elmah/samples/Demo/ErrorsRssView.aspx">Error Log Sample Using XmlDataSource</a></li>
    </ul>
    ...
    <dl>
        ...
        Instead, it drops files with the raw e-mail message into a <a href="../../../elmah/samples/Demo/Mails/"
        title='<%= Server.HtmlEncode(MailPath) %>'>pick-up directory</a>
